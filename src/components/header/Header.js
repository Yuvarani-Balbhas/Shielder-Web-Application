          ...
          <Navbar bg="nav-menu-container" expand="lg">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="ml-auto">
                ...
                <Nav.Item>
                <Button className="genric-btn primary radius text-uppercase" variant="success"  onClick={this.loginClicked}>
                    Login
                  </Button>
                </Nav.Item>
                <Nav.Item>
                <Button className="genric-btn primary radius text-uppercase" variant="success"  href="/register">
                    Signup
                  </Button>
                </Nav.Item>
              </Nav>
