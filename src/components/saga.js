...
function* verifyLogin(action) {
  try{
    const responseData = yield postdata(Base_URL + Constants.API_URLS.LOGIN_VERIFY_URL,
      {
    ...
    const errorMessage = {'success' : false, 'message' : 'Invalid Credentials. Plz check and try again'};
