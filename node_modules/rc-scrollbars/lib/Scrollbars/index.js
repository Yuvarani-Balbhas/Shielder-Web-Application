...
var getScrollbarWidth_1 = __importDefault(require("../utils/getScrollbarWidth"));
var returnFalse_1 = __importDefault(require("../utils/returnFalse"));
var getInnerWidth_1 = __importDefault(require("../utils/getInnerWidth"));
var getInnerHeight_1 = __importDefault(require("../utils/getInnerHeight"));
var styles_1 = require("./styles");
var defaultRenderElements_1 = require("./defaultRenderElements");
var Scrollbars = (function (_super) {
    ...
    Scrollbars.prototype.componentWillUnmount = function () {
        ...
        this.requestFrame && raf_1.cancel(this.requestFrame);
    ...
    Scrollbars.prototype.getThumbHorizontalWidth = function () {
        ...
        var trackWidth = getInnerWidth_1.default(this.trackHorizontal);
    ...
    Scrollbars.prototype.getThumbVerticalHeight = function () {
        ...
        var trackHeight = getInnerHeight_1.default(this.trackVertical);
    ...
    Scrollbars.prototype.addListeners = function () {
        ...
        if (!getScrollbarWidth_1.default())
            return;
    ...
    Scrollbars.prototype.setupDragging = function () {
        dom_css_1.default(document.body, styles_1.disableSelectStyle);
        document.addEventListener('mousemove', this.handleDrag);
        document.addEventListener('mouseup', this.handleDragEnd);
        document.onselectstart = returnFalse_1.default;
    };
    Scrollbars.prototype.teardownDragging = function () {
        dom_css_1.default(document.body, styles_1.disableSelectStyleReset);
    ...
    Scrollbars.prototype.showTracks = function () {
        clearTimeout(this.hideTracksTimeout);
        dom_css_1.default(this.trackHorizontal, { opacity: 1 });
        dom_css_1.default(this.trackVertical, { opacity: 1 });
    };
    Scrollbars.prototype.hideTracks = function () {
        ...
        this.hideTracksTimeout = setTimeout(function () {
            dom_css_1.default(_this.trackHorizontal, { opacity: 0 });
            dom_css_1.default(_this.trackVertical, { opacity: 0 });
        }, autoHideTimeout);
    };
    ...
    Scrollbars.prototype.raf = function (callback) {
        ...
        this.requestFrame = raf_1.default(function () {
    ...
    Scrollbars.prototype._update = function (callback) {
        ...
        if (getScrollbarWidth_1.default()) {
            ...
            var trackHorizontalWidth = getInnerWidth_1.default(this.trackHorizontal);
            ...
            var trackVerticalHeight = getInnerHeight_1.default(this.trackVertical);
            ...
            if (hideTracksWhenNotNeeded) {
                ...
                dom_css_1.default(this.trackHorizontal, trackHorizontalStyle);
                dom_css_1.default(this.trackVertical, trackVerticalStyle);
            }
            dom_css_1.default(this.thumbHorizontal, thumbHorizontalStyle);
            dom_css_1.default(this.thumbVertical, thumbVerticalStyle);
        }
        if (onUpdate)
            onUpdate(values);
    ...
    Scrollbars.prototype.render = function () {
        var _this = this;
        var scrollbarWidth = getScrollbarWidth_1.default();
        var _a = this.props, onScroll = _a.onScroll, onScrollFrame = _a.onScrollFrame, onScrollStart = _a.onScrollStart, onScrollStop = _a.onScrollStop, onUpdate = _a.onUpdate, renderView = _a.renderView, renderTrackHorizontal = _a.renderTrackHorizontal, renderTrackVertical = _a.renderTrackVertical, renderThumbHorizontal = _a.renderThumbHorizontal, renderThumbVertical = _a.renderThumbVertical, tagName = _a.tagName, hideTracksWhenNotNeeded = _a.hideTracksWhenNotNeeded, autoHide = _a.autoHide, autoHideTimeout = _a.autoHideTimeout, autoHideDuration = _a.autoHideDuration, thumbSize = _a.thumbSize, thumbMinSize = _a.thumbMinSize, universal = _a.universal, autoHeight = _a.autoHeight, autoHeightMin = _a.autoHeightMin, autoHeightMax = _a.autoHeightMax, style = _a.style, children = _a.children, props = __rest(_a, ["onScroll", "onScrollFrame", "onScrollStart", "onScrollStop", "onUpdate", "renderView", "renderTrackHorizontal", "renderTrackVertical", "renderThumbHorizontal", "renderThumbVertical", "tagName", "hideTracksWhenNotNeeded", "autoHide", "autoHideTimeout", "autoHideDuration", "thumbSize", "thumbMinSize", "universal", "autoHeight", "autoHeightMin", "autoHeightMax", "style", "children"]);
        var didMountUniversal = this.state.didMountUniversal;
        var containerStyle = __assign(__assign(__assign({}, styles_1.containerStyleDefault), (autoHeight && __assign(__assign({}, styles_1.containerStyleAutoHeight), { minHeight: autoHeightMin, maxHeight: autoHeightMax }))), style);
        var viewStyle = __assign(__assign(__assign(__assign(__assign({}, styles_1.viewStyleDefault), { marginRight: scrollbarWidth ? -scrollbarWidth : 0, marginBottom: scrollbarWidth ? -scrollbarWidth : 0 }), (autoHeight && __assign(__assign({}, styles_1.viewStyleAutoHeight), { minHeight: typeof autoHeightMin === 'string'
        ...
        })), (universal && !didMountUniversal && styles_1.viewStyleUniversalInitial));
        var trackAutoHeightStyle = {
            transition: "opacity " + autoHideDuration + "ms",
            opacity: 0,
        };
        var trackHorizontalStyle = __assign(__assign(__assign({}, styles_1.trackHorizontalStyleDefault), (autoHide && trackAutoHeightStyle)), ((!scrollbarWidth || (universal && !didMountUniversal)) && {
            display: 'none',
        }));
        var trackVerticalStyle = __assign(__assign(__assign({}, styles_1.trackVerticalStyleDefault), (autoHide && trackAutoHeightStyle)), ((!scrollbarWidth || (universal && !didMountUniversal)) && {
            display: 'none',
        }));
        return react_1.createElement(tagName, __assign(__assign({}, props), { style: containerStyle, ref: function (ref) {
                _this.container = ref;
            } }), [
            react_1.cloneElement(renderView({ style: viewStyle }), {
                key: 'view',
                ref: function (ref) {
                    _this.view = ref;
                },
            }, children),
            react_1.cloneElement(renderTrackHorizontal({ style: trackHorizontalStyle }), {
                key: 'trackHorizontal',
                ref: function (ref) {
                    _this.trackHorizontal = ref;
                },
            }, react_1.cloneElement(renderThumbHorizontal({ style: styles_1.thumbHorizontalStyleDefault }), {
                ref: function (ref) {
                    _this.thumbHorizontal = ref;
                },
            })),
            react_1.cloneElement(renderTrackVertical({ style: trackVerticalStyle }), {
                key: 'trackVertical',
                ref: function (ref) {
                    _this.trackVertical = ref;
                },
            }, react_1.cloneElement(renderThumbVertical({ style: styles_1.thumbVerticalStyleDefault }), {
                ref: function (ref) {
    ...
    Scrollbars.defaultProps = {
        renderView: defaultRenderElements_1.renderViewDefault,
        renderTrackHorizontal: defaultRenderElements_1.renderTrackHorizontalDefault,
        renderTrackVertical: defaultRenderElements_1.renderTrackVerticalDefault,
        renderThumbHorizontal: defaultRenderElements_1.renderThumbHorizontalDefault,
        renderThumbVertical: defaultRenderElements_1.renderThumbVerticalDefault,
        tagName: 'div',
        thumbMinSize: 30,
